...
Nella Venezia del 1500 c.a. erano presenti i Privilegi. I privilegi si riferivano alla tecnologia utilizzata. I privilegi erano garantiti agli stampatori, ma non agli autori (riguardo la pubblicazione e alla stampa di documenti-libri).
...
Con l'avvento dell'umanesimo si ha un aumento di persone che tentano di ``scappare'' dalle corporazioni e ottenere dei privilegi: si ha una maggiore attenzione alla necessit\`a di proteggere il proprio lavoro. Molti dotti cominciano a preoccuparsi a problemi pratici, con un assottigliamento dei confini tra conoscenza e capacit\`a meccaniche. Da qui vengono scritti i primi libri in cui si cerca di avere una maggiore importanza alla protezione delle conoscenze, e comincia a cambiare il modo in cui esse vengono trasmesse.


\subsubsection{Inghilterra e Copyright}

Con la prima stamperia nel 1476 (in ritardo rispetto a Venezia) i problemi di copia non autorizzate hanno una ridotta importanza. Con l'introduzione della censura da parte della Corona, e nel 1557 viene dato il controllo esclusivo sulla stampa dei libri alla Stationers Company, posta sotto il controllo della Camera Stellata. Agendo in tale maniera gli autori vengono estromessi dai propri lavori.
...
Nel 1783 una petizione di John Ledyard cambia la situazione. Dopo aver scritto la
